...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/zh-cn/";
          ...
          description: "",
          section: "新闻",},{id: "news-论文-from-stars-to-waves-stochastic-inference-of-microlensed-gravitational-waves-共同第一作者-被physical-review-d录用",
          title: '论文 “From Stars to Waves: Stochastic Inference of Microlensed Gravitational Waves” (共同第一作者) 被Physical...',
          description: "",
